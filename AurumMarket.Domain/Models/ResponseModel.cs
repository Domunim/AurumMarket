...
namespace AurumMarket.Domain.Models
{
    ...
    public class Rates
    {
        [JsonProperty("2021-04-22")] // TODO - change to variables from selected dates, startDate and endDate, keep the YYYY-MM-DD format
        public startDateRates StartDateRates { get; set; }
        [JsonProperty("2021-04-23")]
        public endDateRates EndDateRates { get; set; }
    }

    public class startDateRates
    {
